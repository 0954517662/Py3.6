...
poll = LinePoll(cl)
call = cl
creator = ["u650a026a4e01f16e1308813b8f74aad9"]
owner = ["u650a026a4e01f16e1308813b8f74aad9"]
admin = ["u650a026a4e01f16e1308813b8f74aad9"]
                 ...
                 if wait["detectMention"] == True:
                   ...
                   for mention in mentionees:
                        if mention ['M'] in Bots:
                           ...
                           cl.sendMessage(msg.to, None, contentMetadata={"STKID":"68358132","STKPKGID":"4233636","STKVER":"1"}, contentType=7)
                           break
               if 'MENTION' in msg.contentMetadata.keys() != None:
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                Setmain["changePicture"][mid] = True
                                cl.sendText(msg.to,"Kirim fotonya.....")
